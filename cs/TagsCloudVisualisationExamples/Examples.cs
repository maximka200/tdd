...
public class Examples
{
    ...
    [Test]
    public void WithFixedBlueRectangles_ShouldCorrectSaveImage()
    {
    ...
    [Test]
    public void WithRandomRectangleColorsOnDarkBackground_ShouldCorrectSaveImage()
    {
    ...
    [Test]
    public void WithShiftedCenter_ShouldCorrectSaveImage()
    {
    ...
    [Test]
    public void WithDifferentRectangles_ShouldCorrectSaveImage()
    {
    ...
    [Test]
    public void WithGrowingRectangles_ShouldCorrectSaveImage()
    {
